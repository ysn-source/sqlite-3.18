...
#define SQLITE_DBCONFIG_ENABLE_SP		      1007 /* int int* */
...
#define SQLITE_CREATE_TEMP_SP       34   /* Trigger Name    Table Name      */
#define SQLITE_CREATE_SP            35   /* Trigger Name    Table Name      */
#define SQLITE_DROP_TEMP_SP         36   /* Trigger Name    Table Name      */
#define SQLITE_DROP_SP              37   /* Trigger Name    Table Name      */
/*
...
/*
** CAPI3REF: Put bind variable from db to Statement
** METHOD: sqlite3
**
** The sqlite3_bind_copy(sqlite3_stmt*,int) method allows the application to
**
**
*/
#define SQLITEBIND_IN 0x1
#define SQLITEBIND_OUT 0x0
SQLITE_API int SQLITE_APICALL sqlite3_bind_copy(sqlite3_stmt*,int);
