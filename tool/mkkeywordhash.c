...
#endif
#ifdef SQLITE_OMIT_WINFUNC
#  define WIN        0
#else
#  define WIN        0x00080000
#endif
...
static Keyword aKeywordTable[] = {
  ...
  { "VIEW",             "TK_VIEW",         VIEW                   },
  { "WEBVIEW",          "TK_WEBVIEW",      VIEW					  },
  { "WEBPROC",          "TK_WEBPROC",      ALWAYS	              },
  { "WEBUSR",           "TK_WEBUSR",       ALWAYS				  },
  { "WEBPWD",           "TK_WEBPWD",       ALWAYS                 },
  { "WEBGRP",           "TK_WEBGRP",       ALWAYS                 },
